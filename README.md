...
# 2.5  Создание запроса к модели  помощью протокала REST на виртуальную машину Heroku

Создайте новый скрипт в папке вашего проекта с именем predict.py и добавьте следующие строки кода для импорта некоторых пакетов:
